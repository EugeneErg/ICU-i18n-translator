...
namespace EugeneErg\Translate\Clients\MicrosoftTranslator;

use EugeneErg\Translate\Clients\Contracts\ClientInterface;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Detect;
use EugeneErg\Translate\Clients\MicrosoftTranslator\DetectLanguage;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Dictionary;
use EugeneErg\Translate\Clients\MicrosoftTranslator\LanguageListResponse;
use EugeneErg\Translate\Clients\MicrosoftTranslator\LanguageTranslation;
use EugeneErg\Translate\Clients\MicrosoftTranslator\LanguageTransliteration;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Scope;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Script;
use EugeneErg\Translate\Clients\MicrosoftTranslator\TranslateResponse;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Translation;
use EugeneErg\Translate\Clients\MicrosoftTranslator\TranslationText;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Transliteration;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Exceptions\AuthenticationException;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Exceptions\ClientException;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Exceptions\InvalidRequestException;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Exceptions\InvalidResponseException;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Exceptions\MicrosoftTranslatorExceptionInterface;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Exceptions\NetworkException;
use EugeneErg\Translate\Clients\MicrosoftTranslator\Exceptions\RequestException;
use EugeneErg\Translate\Clients\MicrosoftTranslator\ValueObjects\AuthorizationInterface;
use EugeneErg\Translate\Clients\MicrosoftTranslator\ValueObjects\LanguageDirection;
use EugeneErg\Translate\Clients\MicrosoftTranslator\ValueObjects\ProfanityAction;
use EugeneErg\Translate\Clients\MicrosoftTranslator\ValueObjects\ProfanityMarker;
use EugeneErg\Translate\Clients\MicrosoftTranslator\ValueObjects\TranslationType;
use JsonException;
